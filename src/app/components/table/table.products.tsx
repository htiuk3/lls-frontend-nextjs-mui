...
export default function ProductsTable({ meta, list }: ProductsTableProps) {
  const rows = list.map((item, index) => ({ ...item, stt: index + 1 }))
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      padding="none"
                    >
                      <Box display={"flex"} alignItems={"center"} gap={1}><Avatar src={row.kiotImage} /> {row.name}</Box>
                    </TableCell>
                    <TableCell align="right">{row.kiotCategoryId}</TableCell>
